...
CFLAGS := -DESP_PLATFORM -DMBEDTLS_CONFIG_FILE="mbedtls/esp_config.h" -DHAVE_CONFIG_H -DGCC_NOT_5_2_0=0 -DWITH_POSIX -std=gnu99 -Os -g3 -fstack-protector -ffunction-sections -fdata-sections -fstrict-volatile-bitfields -mlongcalls -nostdlib $(WARNING_FLAGS) -MMD
...
.PHONY : install
install :
	mkdir -p $(HOME)/Documents/Arduino/libraries/libmapper
	cp -R $(OUTPUT_DIR)/. $(HOME)/Documents/Arduino/libraries/libmapper
