if(APPLE)
    set(ARDUINO_ROOT "$ENV{HOME}/Documents/Arduino/hardware/espressif/esp32")
    set(ARDUINO_LIBRARY_PATH "$ENV{HOME}/Documents/Arduino/libraries")
elseif(UNIX)
    set(ARDUINO_ROOT "$ENV{HOME}/.arduino15/packages/esp32")
...
set(SDK ${ARDUINO_ROOT}/tools/sdk)
set(tools ${ARDUINO_ROOT}/tools/xtensa-esp32-elf)
