if(APPLE)
    set(ARDUINO_ROOT "$ENV{HOME}/Library/Arduino15")
    set(ARDUINO_LIBRARY_PATH "$ENV{HOME}/Documents/Arduino/libraries")
elseif(UNIX)
    set(ARDUINO_ROOT "$ENV{HOME}/.arduino15")
    set(ARDUINO_LIBRARY_PATH "$ENV{HOME}/Arduino/libraries")
else()
    message(FATAL_ERROR "Toolchain not implemented on this host OS. Please modify arduino-esp32.cmake.")
endif()
set(SDK ${ARDUINO_ROOT}/packages/esp32/hardware/esp32/1.0.4/tools/sdk)
set(tools ${ARDUINO_ROOT}/packages/esp32/tools/xtensa-esp32-elf-gcc/1.22.0-80-g6c4433a-5.2.0)
